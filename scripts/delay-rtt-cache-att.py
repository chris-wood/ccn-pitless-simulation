...
def main(argv):
    rtts = {}
    fileNames = ["data_RTT/delay-rtt-pitfull-cache-att",
                 "data_RTT/delay-rtt-pitless-cache-att",
                 "data_RTT/delay-rtt-pitless-cache-hybrid-att"]
    numberOfFiles = 3
    ...
    pdf = PdfPages("delay-rtt-cache-att.pdf")
    pdf.savefig(fig)
    pdf.close()
