...
def main(argv):
    rtts = {}
    fileNames = ["data_RTT/delay-rtt-pitfull-cache-dfn",
                 "data_RTT/delay-rtt-pitless-cache-dfn",
                 "data_RTT/delay-rtt-pitless-cache-hybrid-dfn"]
    numberOfFiles = 3
    ...
    pdf = PdfPages("delay-rtt-cache-dfn.pdf")
    pdf.savefig(fig)
    pdf.close()
