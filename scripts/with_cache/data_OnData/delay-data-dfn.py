...
def main(argv):
    delays = {}
    fileNames = ["data_OnData/delay-data-pitfull-cache-dfn",
                 "data_OnData/delay-data-pitless-cache-dfn",
                 "data_OnData/delay-data-pitless-cache-hybrid-dfn"]
    numberOfFiles = 3
    ...
    pdf = PdfPages("delay-data-dfn.pdf")
    pdf.savefig(fig)
    pdf.close()
